                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Просмотр отчетов</p>
                            <a href="{{route('reports.main')}}" class="btn btn-primary">Перейти</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="{{route('users.main')}}" class="btn btn-primary">Перейти</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="{{route('requests.index')}}" class="btn btn-primary">Перейти</a>
                        </div>
                    </div>
                </div>
            </div>
